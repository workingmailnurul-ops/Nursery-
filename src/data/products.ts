...
export const TESTIMONIALS: Testimonial[] = [
  ...
  },
  {
    ...
    city: 'Ahmedabad, GJ',
    rating: 5,
    comment: '100% genuine mother plant scions! I ordered 25 Katimon mango trees for my orchard project near Junagadh. Talukdar Nursery provided excellent planting advice.',
  ...
  },
  {
    ...
    city: 'Siliguri, WB',
    rating: 5,
    comment: 'Fast India Post / Courier dispatch and genuine scions certified by nursery tag. Highly recommend Talukdar Nursery to every plant enthusiast across India.',
